...
| [`compress-image.html`](compress-image.html) | Compresses an image toward a target file size in the output format you choose, with pros and cons for PNG, JPEG and WebP, then repeatedly reduces dimensions if needed. Everything runs in the browser. |
